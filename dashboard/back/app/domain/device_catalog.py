...
class DeviceCatalogBuilder(BaseHelper):
    ...
    def device_from_vehicle(self, item: dict[str, Any], camera: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        return {
            ...
            "vehicle_type_name": self.text(item.get("vehicle_type_name") or item.get("tipo_vehiculo_nombre")),
            "vehicle_subtype": self.text(item.get("vehicle_subtype") or item.get("tipo_automovil_codigo")),
            "vehicle_subtype_name": self.text(item.get("vehicle_subtype_name") or item.get("tipo_automovil_nombre")),
            "driver_name": self.text(item.get("driver_name") or item.get("chofer")),
