...
class Settings(BaseSettings):
    ...
    mediamtx_webrtc_base_url: str = Field(default="http://127.0.0.1:8889", alias="MEDIAMTX_WEBRTC_BASE_URL")
    ...
    ssh_events_host: str = Field(default="", alias="SSH_EVENTS_HOST")
    ssh_events_user: str = Field(default="", alias="SSH_EVENTS_USER")
    ssh_events_password: str = Field(default="", alias="SSH_EVENTS_PASSWORD")
    ssh_events_port: int = Field(default=22, alias="SSH_EVENTS_PORT")
    ssh_events_base_path: str = Field(default="", alias="SSH_EVENTS_BASE_PATH")
    ...
    smtp_sender_email: str = Field(default="", alias="SMTP_SENDER_EMAIL")
    smtp_sender_password: str = Field(default="", alias="SMTP_SENDER_PASSWORD")
    smtp_host: str = Field(default="smtp.office365.com", alias="SMTP_HOST")
    smtp_port: int = Field(default=587, alias="SMTP_PORT")
    notification_default_recipients: str = Field(default="", alias="NOTIFICATION_DEFAULT_RECIPIENTS")
    telegram_default_chat_ids: str = Field(default="", alias="TELEGRAM_DEFAULT_CHAT_IDS")
    ...
    plate_lookup_embedded_worker_enabled: bool = Field(
        default=False, alias="PLATE_LOOKUP_EMBEDDED_WORKER_ENABLED"
    )
    ...
    artemis_session_id: str = Field(default="", alias="ARTEMIS_SESSION_ID")
    artemis_captcha: str = Field(default="", alias="ARTEMIS_CAPTCHA")
    artemis_poll_interval: int = Field(default=5, alias="ARTEMIS_POLL_INTERVAL")
    artemis_company_id: str = Field(default="", alias="ARTEMIS_COMPANY_ID")
    cache_max_age_days: int = Field(default=7, alias="CACHE_MAX_AGE_DAYS")
